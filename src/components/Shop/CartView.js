...
import { createBuyOrder} from "../../data/BBDD";
...
<div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="py-10">
          <input id = "nombre" type="text" placeholder="Nombre y Apellido" className="input input-bordered w-full max-w-xs" required />
          <input id = "email" type="email" placeholder="Email" className="input input-bordered w-full max-w-xs" required />
          <input id = "tel" type="tel" placeholder="Telefono" className="input input-bordered w-full max-w-xs" required />
          <input id = "direccion" type="text" placeholder="direccion" className="input input-bordered w-full max-w-xs" required />
